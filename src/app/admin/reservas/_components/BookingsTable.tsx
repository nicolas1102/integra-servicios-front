...
import BookingsTableColumns from '../_lib/BookingsTableColumns'

export function BookingsTable({ data }: { data: ReservaInterface[] }) {

  const { table, columns } = BookingsTableColumns({ data })
  return (
